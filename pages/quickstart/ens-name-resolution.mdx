...
<div class = "info mt-20">
    <h3 className = "mb-5">**Live Example**</h3>
    <p className = "mb-5">On **Sepolia**, the ETH address for [`ethglobal.eth`](https://sepolia.app.ens.domains/ethglobal.eth) resolves using this exact solution.</p>
    <p className = "mb-5">The resolver it is using is deployed and verified on **Sepolia** [here](https://sepolia.etherscan.io/address/0x44a40a4479e49e54b51269d2a143bb428205a806#code).</p>
    <p>The data contract is deployed and verified on **Optimism Sepolia** [here](https://sepolia-optimism.etherscan.io/address/0xbf6d2c96547bb015961cb38d30596a781c7039e1#code).</p>
</div>
...
- Replace `YOUR-PRIVATE-KEY` with your deployment private key.
- Replace `VERIFIER-ADDRESS` with the verifier address for your chosen L2. This can be found [here](/verifiers/deployments).

<div class = "info mt-20">
	<p>**!!** Take note of finalization times.</p> 
    <p>**!!** Our Sepolia Verifiers/Gateways relax finalization rules for speed of development. [Read more](/verifiers/deployments).</p> 
</div>
...
You can do this through the [ENS App](https://sepolia.app.ens.domains/). 

**Note:** Make sure you are connected to the correct network. 
...
```bash
https://sepolia.app.ens.domains/YOUR-NAME-HERE.eth
```
...
For further guidance we recommend that you read through the rest of the documentation. Especially our [examples](/examples) section. If you still can't find an answer we would be happy to help you out on our [Discord](https://discord.gg/QtrHVK3U8c).