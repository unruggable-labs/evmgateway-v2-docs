...
<MethodPartial 
    description = "Allows you to read bytes of arbitrary length by proving against a hash of the data."
    js= "readHashedBytes()"
...
<MethodPartial 
    description = "Duplicates the item at the specified position from the head of the stack, and places the duplicate at the head."
    js= "dup(back = 0)"
    solidity = "dup() / dup(uint256 back)" />

<MethodPartial 
    description = "Swaps the item at the head of the stack with the item at the specified position from the head of the stack."
    js= "swap(back = 1)"
    solidity = "swap() / swap(uint256 back)" />

<MethodPartial 
    description = "Pushes a specific output back onto the top of the stack."
    js= "pushOutput(i: number)"
    solidity = "pushOutput(uint256 i)" />

<MethodPartial 
    description = "Copies the item at the specified index in the stack to the top of the stack."
...
<MethodPartial 
    description = "Push the individual bytes of a string onto the stack. "
    js= "pushStr(s: string)"
    solidity = "" />

<MethodPartial 
    description = "Pushes the specified bytes onto the stack."
    js= "pushBytes(v: BytesLike)"
    solidity = "" />

<MethodPartial 
    description = "Pushes the encoded bytes of a GatewayProgram onto the stack."
