...
Our stack-based [virtual machine](https://github.com/unruggable-labs/unruggable-gateways/blob/main/contracts/GatewayVM.sol) is designed to read data from EVM-compatible rollups and generate proofs that can be returned to and verified on Layer 1.

A [`GatewayRequest`](https://github.com/unruggable-labs/unruggable-gateways/blob/b109adcfe29c50d19efae93129a689a213d692dc/contracts/GatewayRequest.sol#L4) constitutes a single `bytes` type that holds sequential OP codes(See our [Builder API Methods](/architecture/builder-api-methods)) that are interpreted by the virtual machine.
