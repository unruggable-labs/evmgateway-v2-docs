...
Taiko is EVM compatible and implements its account and storage tries using your standard Patricia Merkle Trie. We verify the returned proofs using the `SecureMerkleTrie.sol` library from within our `EthVerifierHooks.sol` contract.
